...
#bot = telepot.Bot('894499253:AAEJkSLxJKp6TR1R4pIleXUv8z0oj2yIROg')
#bot = telepot.Bot('555903982:AAGsXhZ0sPNTEMsUc9dQ_a-c8Ag1AuHVjnM')
...
def handle(msg):
    ...
    if 'text' in msg:
        ...
        if ("Handwriting"or"Font"or"Paper"or"Document"or"Paper product")in IMAGE_LABELS:
            try :
        ...
        elif ("Plant"or"Grape leaves"or"Flowering plant"or"Deciduous")in IMAGE_LABELS:
            try :
...
main_chat_id=[414553391,689969913,1210750385,1378878389]
